...
<?php
session_start();
$role = isset($_SESSION['dname']) ? 'Doctor' : 'Admin';
session_destroy();
?>
<html lang="en">
<head>
    ...
    <style>
        :root { --indigo:#4f46e5; --navy:#0f172a; --white:#ffffff; }
        * { margin:0; padding:0; box-sizing:border-box; }
        ...
        .logout-icon {
            ...
            background:rgba(79,70,229,.15); border-radius:50%;
            display:flex; align-items:center; justify-content:center;
            font-size:30px; color:var(--indigo); margin:0 auto 24px;
        ...
        .spinner {
            ...
            border-top:2px solid var(--indigo); border-radius:50%;
        ...
        .progress-fill {
            height:100%; background:var(--indigo); border-radius:10px;
        ...
        .btn-home:hover { background:#4338ca; transform:translateY(-1px); color:#fff; }
    </style>
</head>
<body>
    <div class="logout-card">
        ...
        <p>Your <?= $role ?> session has ended securely. Thank you for using Afya One Hospital Management System.</p>
